...
The full CCOG Markdown artifact under `.agents/skills/apex-ccog-resolver/resource/ccog_reference_full.md` was repaired for OCR/code-formatting errors only. The runtime merges that full reference with the curated `jobagg/classification/rules/ccog_reference.yaml` subset.
