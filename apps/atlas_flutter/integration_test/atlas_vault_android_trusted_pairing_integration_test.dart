  ...
  testWidgets('Android protected pairing state persists across processes', (
    ...
    if (stage == 'journey') {
      ...
      tester.printToConsole(
        'Android explicit inviter/invitee pairing and artifact exchange passed.',
      );
      return;
    }
    if (stage == 'prepare') {
...
final class _AndroidPairingScenario {
  ...
  runExplicitRoleCycle() async {
    final stores = AtlasVaultPairingPlatformStores(
      ...
      staging: stageStore,
      secureKey: AtlasAndroidVaultSecureKeyStore(),
      localStore: AtlasAndroidVaultLocalStoreIO(),
      selectedVault: AtlasAndroidSelectedVaultStore(),
    );
