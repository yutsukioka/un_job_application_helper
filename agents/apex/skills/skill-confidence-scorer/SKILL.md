...
2. Build the skill registry: for each `agents/apex/skills/*/SKILL.md`, read
   the YAML frontmatter (`name`, `description`) and the `## Purpose`
   section.
3. Build the context snapshot: scan `private/inputs/application_context.md` for
...
File: `private/output/tmp/0x_skill_confidence_scores.md`
