...
- `expected_output_spec`: the relevant `## Output Format` block from
  ...
  `agents/apex/skills/<skill_name>/SKILL.md` if not provided).
...
File: `private/output/tmp/test_suite/0x_skill_failure_analysis.md`
...
Target:
<file to modify — e.g., "agents/apex/skills/<skill>/SKILL.md" or "apex-orchestrator-report">
