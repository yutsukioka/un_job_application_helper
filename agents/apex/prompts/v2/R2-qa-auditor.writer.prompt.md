...
5. Join the coordination server with:
   python agents/apex/agent_sync/client_v6.py join qa-auditor --port 9861
...
1. IMPLEMENT pass 1:
   ...
   - Record final review skills:
     python agents/apex/scripts/write_run_manifest.py add-skill --outdir <OUTDIR> --skill apex-application-audit --server R2 --artifact application_audit.md
   - Finalize `_discussion/run_manifest.json`:
     python agents/apex/scripts/write_run_manifest.py finalize --outdir <OUTDIR>
   ...
   - Call:
     python agents/apex/agent_sync/client_v6.py impl-done qa-auditor --summary "<short>" --port 9861
2. TEST:
...
3. DISCUSS / shutdown:
   ...
   - Close or loop:
     python agents/apex/agent_sync/client_v6.py discuss-done qa-auditor --next-impl qa-auditor --port 9861
     python agents/apex/agent_sync/client_v6.py discuss-done qa-auditor --port 9861
     python agents/apex/agent_sync/client_v6.py shutdown --reason "R2 complete" --port 9861
