...
5. Join the coordination server with:
   python agents/apex/agent_sync/client_v6.py join qa-auditor --port <PORT>
...
2. Append consumed messages to:
   private/output/generated_documents/history/<JOB_SLUG>/_discussion/advisor_notes_<SERVER>.md
...
- ALLOWED: private/output/generated_documents/history/<JOB_SLUG>/_discussion/advisor_notes_<SERVER>.md
