...
4. Join the coordination server with:
   python agents/apex/agent_sync/client_v6.py join screening-lead --port 9800
...
1. IMPLEMENT pass 1:
   ...
   - Initialize the run manifest:
     python agents/apex/scripts/write_run_manifest.py init --outdir <OUTDIR> --job-slug <JOB_SLUG> --target-system <TARGET_SYSTEM>
   ...
   - Record invoked skills in `_discussion/run_manifest.json`:
     python agents/apex/scripts/write_run_manifest.py add-skill --outdir <OUTDIR> --skill term-extractor --server P0a --artifact phase1_2_core_requirements.md
     python agents/apex/scripts/write_run_manifest.py add-skill --outdir <OUTDIR> --skill apex-jd-core-requirements --server P0a --artifact phase1_2_core_requirements.md
     python agents/apex/scripts/write_run_manifest.py add-skill --outdir <OUTDIR> --skill apex-progression-metric-ledger --server P0a --artifact metric_ledger.md
...
3. DISCUSS: read `_discussion/advisor_notes_P0a.md`. Submit one structured
   ...
   DISCUSS barrier can advance (qa-auditor adds `--next-impl`).
     python agents/apex/agent_sync/client_v6.py discuss   screening-lead "<text>" --port 9800
     python agents/apex/agent_sync/client_v6.py discuss-done screening-lead --port 9800
