...
- Topology: [`agents/apex/topology/server_manifest.yaml`](../../topology/server_manifest.yaml)
- Design spec: [`agents/apex/`](../../../agents/apex/)
- Runbook: [`agents/apex/topology/runbook.md`](../../../agents/apex/topology/runbook.md)

## When to use these prompts

Only when `## RUN_MODE` in `private/inputs/application_context.md` declares
...
- The agent's `.agent.md` file (in `agents/apex/.github/agents/`) provides
