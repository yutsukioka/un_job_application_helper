...
- `private/output/generated_documents/history/<JOB_SLUG>/option1_admin_profile.md`
- `private/output/generated_documents/history/<JOB_SLUG>/option2_cv.md`
- `private/output/generated_documents/history/<JOB_SLUG>/option3_cover_letter.md`
- `private/output/generated_documents/history/<JOB_SLUG>/option4_qualification_answers.md` if it exists
- `private/output/generated_documents/history/<JOB_SLUG>/option7_motivation_statement.md` if requested/generated

Do not read full `private/inputs/application_context.md`, `private/inputs/history/**`,
...
- into `private/output/generated_documents/history/<JOB_SLUG>/independent_shortlisting_risk_review.md` only if explicitly assigned as implementer, or
