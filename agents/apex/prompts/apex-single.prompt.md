...
from private/inputs/application_context.md and the workspace skill artifacts.
...
Read LIMITS.TARGET_SYSTEM from private/inputs/application_context.md and select the
...
I read private/inputs/application_context.md. If core sections (job history, job
