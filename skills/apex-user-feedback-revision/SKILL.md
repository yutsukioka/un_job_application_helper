...
1. Search `output/` recursively for `phase1_7_strategy_report*.md` and choose
...
Always write:
- `output/0x_user_feedback_revision.md`

Write only when `USER_INTENT_APPLY_UPDATES: YES`:
- `inputs/user_feedback_updates.md`

### Artifact 1: `output/0x_user_feedback_revision.md`
...
### Artifact 2: `inputs/user_feedback_updates.md`
...
6. Write `output/0x_user_feedback_revision.md`.
