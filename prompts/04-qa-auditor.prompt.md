...
4. Send the canonical:
   python .agents/agent_sync/client_v6.py test-result qa-auditor --passed --output "<SUMMARY>" --port 9800
...
3. Close the round with:
   python .agents/agent_sync/client_v6.py discuss-done qa-auditor --next-impl <OWNER> --port 9800
