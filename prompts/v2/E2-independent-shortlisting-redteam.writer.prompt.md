...
3. Load `.agents/.github/agents/independent-shortlisting-redteam.agent.md`.
...
1. IMPLEMENT:
   ...
   - Call:
     python .agents/agent_sync/client_v6.py impl-done independent-shortlisting-redteam --summary "<short>" --port 9852
2. TEST:
   - Self-check that the report is adversarial, evidence-grounded, and does
     not edit or rewrite the application.
   - Call:
     python .agents/agent_sync/client_v6.py test-result independent-shortlisting-redteam --passed --output "<summary>" --port 9852
3. DISCUSS / shutdown:
   - Call:
     python .agents/agent_sync/client_v6.py discuss independent-shortlisting-redteam "ISSUE=none | FILE=independent_shortlisting_risk_review.md | OWNER=independent-shortlisting-redteam | NEXT=shutdown | ACTION=E2 complete | BLOCKER=no" --port 9852
     python .agents/agent_sync/client_v6.py discuss-done independent-shortlisting-redteam --port 9852
     python .agents/agent_sync/client_v6.py shutdown --reason "E2 complete" --port 9852
