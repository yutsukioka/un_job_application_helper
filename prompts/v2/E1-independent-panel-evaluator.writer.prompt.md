...
3. Load `.agents/.github/agents/independent-panel-evaluator.agent.md`.
...
1. IMPLEMENT:
   ...
   - Call:
     python .agents/agent_sync/client_v6.py impl-done independent-panel-evaluator --summary "<short>" --port 9851
2. TEST:
   - Self-check that the report is skeptical, evidence-grounded, and does
     not edit or rewrite the application.
   - Call:
     python .agents/agent_sync/client_v6.py test-result independent-panel-evaluator --passed --output "<summary>" --port 9851
3. DISCUSS / shutdown:
   - Call:
     python .agents/agent_sync/client_v6.py discuss independent-panel-evaluator "ISSUE=none | FILE=independent_panel_evaluation.md | OWNER=independent-panel-evaluator | NEXT=shutdown | ACTION=E1 complete | BLOCKER=no" --port 9851
     python .agents/agent_sync/client_v6.py discuss-done independent-panel-evaluator --port 9851
     python .agents/agent_sync/client_v6.py shutdown --reason "E1 complete" --port 9851
