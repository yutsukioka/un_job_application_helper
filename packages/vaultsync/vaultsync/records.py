...
SUPPORTED_PLAINTEXT_RECORD_TYPES = frozenset(
    {
        "saved_text",
        "saved_search",
        "saved_job",
...
class PlaintextRecord:
    ...
    def __post_init__(self) -> None:
        if self.type not in SUPPORTED_PLAINTEXT_RECORD_TYPES:
        ...
        if self.type == "saved_text" and not isinstance(payload.get("text"), str):
